/******************************************************************************
 * @file     vio_NUCLEO-G031K8.c
 * @brief    Virtual I/O implementation for board NUCLEO-G031K8
 * @version  V1.0.0
...
/*! \page vio_NUCLEO-G031K8 Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioLED0       | vioSignalOut.0 | LED green   (LD3)    | PC6
*/
